...
peripheralclock myotherclock(
	...
	.ddrclock(sys_clk_i),		// DDR base clock @200.0Mhz (could be @166.66667Mhz)
...
// Sync to cpu clock
logic [3:0] switches0, switches1, switches2;
logic [2:0] buttons0, buttons1, buttons2;
...
riscvcpu mycpu(
	...
	.ifetch(ifetch),			// High when attempting to fetch an instruction
